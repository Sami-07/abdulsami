                ...
                {projects.map(project => {
                    return (
                        <div key={project.title} className="flex flex-col xl:flex-row  items-center">
                            <div>
                                <div  data-aos="fade-up" className="hidden md:block relative hover:-translate-y-2 ease-in-out transition hover:scale-105">
                                ...
                                <div  data-aos="fade-up" className="block md:hidden relative hover:-translate-y-2 ease-in-out transition hover:scale-105">
